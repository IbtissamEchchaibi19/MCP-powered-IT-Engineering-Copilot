...
categories_dict = {
    "Infrastructure / Cloud": "Kubernetes, AWS, Hetzner, Docker, server setup, networking",
    "Code / Automation": "Code snippets, CI/CD pipelines, scripts, programming help, language server intelligence",
    "Documentation / Knowledge": "Internal docs, wiki pages, project documentation, technical notes",
    "Database / Query": "SQL queries, structured logs, database access, data extraction",
    "Logs / Monitoring": "System metrics, application logs, debugging info, Splunk queries",
    "APIs / Integration": "REST/OpenAPI, API references, API calls, integration guides",
    "Tooling / Package Management": "Homebrew, CLI tools, software installation, automation tools"
}
